...
export const metadata: Metadata = {
  title: "Fresh Fund - Israeli Venture Capital Fund",
  description: "Fresh Fund is a Tel Aviv-based venture capital firm investing in exceptional tech founders. We provide capital, expertise, and network to accelerate growth.",
  keywords: "venture capital, Israeli tech, startup funding, investment fund, Tel Aviv",
  metadataBase: new URL("https://freshfund.com"),
  alternates: {
    canonical: "https://freshfund.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Fresh Fund - Invest in Israeli Tech Innovation",
    description: "Partner with Fresh Fund: A venture capital firm backing exceptional tech founders in Israel and globally.",
    siteName: "Fresh Fund",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765810241908-tyzio2jn.jpg",
      alt: "Fresh Fund venture capital partnership"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Fresh Fund - Israeli Venture Capital",
    description: "Investing in exceptional tech founders with capital, expertise, and strategic guidance.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765810241908-tyzio2jn.jpg"]
  }
};
